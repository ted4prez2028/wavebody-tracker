...
import { Wifi, Bluetooth, Map, Navigation, Radar } from "lucide-react";
  ...
  return (
    <div className="w-64 border-r border-border bg-card p-4 flex flex-col overflow-auto shrink-0">
      ...
      <div className="mt-auto pt-6">
        <Button className="w-full bg-wavebody-blue hover:bg-wavebody-purple transition-colors">Scan Area</Button>
      </div>
    </div>
  );
};
